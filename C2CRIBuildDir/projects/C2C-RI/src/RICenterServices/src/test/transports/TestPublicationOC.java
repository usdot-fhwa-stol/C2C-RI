 ...
 */
public class TestPublicationOC {
    ...
    private final Logger log = LoggerFactory.getLogger(TestPublicationOC.class);

    public static void main(String[] args) {
        TestPublicationOC subec= new TestPublicationOC();
        try{
        subec.publicationEC();
        } catch (Exception ex){
            ex.printStackTrace();
    ...
    public void publicationEC() throws Exception{
        try {
            ...
            Message newMessage = theManager.createMessage(publicationDialog);
...
//            newMessage.setMessageBody(errorBytes);
            ...
            Message responseMessage = theApplicationLayerStandard.publication_oc(publicationDialog, newMessage);
