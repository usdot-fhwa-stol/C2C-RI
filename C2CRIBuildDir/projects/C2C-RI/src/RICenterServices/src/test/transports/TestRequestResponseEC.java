 ...
 */
public class TestRequestResponseEC {
    ...
    private final Logger log = LoggerFactory.getLogger(TestRequestResponseEC.class);

    public static void main(String[] args) {
        TestRequestResponseEC rrec= new TestRequestResponseEC();
        try{
        rrec.requestResponseEC();
        } catch (Exception ex){
            ex.printStackTrace();
        }
        System.exit(0);
    ...
    public void requestResponseEC() throws Exception{
        try {
            ...
            Message newMessage = theManager.createMessage(requestDialog);
...
//            newMessage.setMessageBody(errorBytes);
            ...
            Message responseMessage = theApplicationLayerStandard.request_response_ec(requestDialog, newMessage);
