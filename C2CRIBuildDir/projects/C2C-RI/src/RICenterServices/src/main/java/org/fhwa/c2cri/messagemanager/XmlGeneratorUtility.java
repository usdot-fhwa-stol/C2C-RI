...
public class XmlGeneratorUtility
{
    ...
    /**
     * Instantiates a new xml generator utility.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     * @param soapEnc the soap enc
     */
    public XmlGeneratorUtility(boolean soapEnc)
    {
        _soapEnc = soapEnc;
    }

    /**
     * Creates the sample for type.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
    ...
    public static String createSampleForType(SchemaType sType)
    {
        ...
        new XmlGeneratorUtility(true).createSampleForType(sType, cursor);
    ...
    */
    /**
     * Gets the item name or type.
     *
     * @param sp the sp
     * @param xmlc the xmlc
     * @return the item name or type
     */
     ...
     * Post-Conditions: N/A
     *
     * @param numToMove the num to move
     * @param xmlc the xmlc
     */
