 ...
 * multi-language use.
 */
public class JLabeldRadioButton extends JPanel implements ActionListener {
     ...
     *
     */
    public JLabeldRadioButton() {
        super();
        this.setSize(400,400);
        this.add(mLabel);
    }

    public JLabeldRadioButton(String label, String[] items) {
        mLabel.setText(label);
        this.setSize(50,400);
        init(items, label);
    }

    public JLabeldRadioButton(String label, String[] items, String selectedItem) {
        mLabel.setText(label);
