...
public class SampleXmlUtilDoctored {
...
//                returnString = returnString+SimpleTypeDetails(possibleTypes[ii]);
                returnString = SimpleTypeDetails(possibleTypes[ii], theDetails);
            }
            return returnString;
        }
...
//            return"MinLength: "+", MaxLength: "+", MinInclusive: "+", MaxInclusive: "+", Enumeration: "+enumValues[pick(enumValues.length)].getStringValue();
    ...
    private void processElement(SchemaParticle sp, XmlCursor xmlc, boolean mixed) {
        ...
        try {
            ...
            outputLine = element.getName().getLocalPart() + "," + element.getType().getSourceName().substring(element.getType().getSourceName().lastIndexOf("/") + 1) + "," + elementType + "," + level + "," + messageName + "," + parent + "," + lastParentType;
...
//              nex.printStackTrace();
            ...
            String elementType = "***TypeError***";
            if (messageName.equals(element.getName().getLocalPart())) {
                elementType = messageName;
            }
            outputLine = element.getName().getLocalPart() + "," + element.getType().getSourceName().substring(element.getType().getSourceName().lastIndexOf("/") + 1) + "," + elementType + "," + level + "," + messageName + "," + parent + "," + parentType;
...
//                if (element.getType().getBaseType().getName().getLocalPart().equals(offset)updateMsgValue(createSampleForType(element.getType().getBaseType()));
                System.out.println(outputLine + "," + elementPath + "/" + element.getName().getLocalPart() + "," + element.getType().getBaseType().getName().getLocalPart() + ", " + element.getMinOccurs() + ", " + element.getMaxOccurs() + ", " + theDetails.output() + "," + isMsgValueStored() + "," + (isMsgValueStored() ? getMessageValue() : ""));
                writeResults(outputLine + "," + elementPath + "/" + element.getName().getLocalPart() + "," + element.getType().getBaseType().getName().getLocalPart() + ", " + element.getMinOccurs() + ", " + element.getMaxOccurs() + ", " + theDetails.output() + "," + isMsgValueStored() + "," + (isMsgValueStored() ? getMessageValue() : " "));
                clearMessageValue();
                ...
                if (!element.getType().isSimpleType()) {
                    ...
                    System.out.println(outputLine + "," + elementPath + "/" + element.getName().getLocalPart() + "," + element.getType().getBaseType().getName().getLocalPart() + ", " + element.getType().getContentModel().getMinOccurs() + ", " + element.getType().getContentModel().getMaxOccurs() + ", " + theDetails.output() + "," + isMsgValueStored() + "," + (isMsgValueStored() ? getMessageValue() : ""));
                    writeResults(outputLine + "," + elementPath + "/" + element.getName().getLocalPart() + "," + element.getType().getBaseType().getName().getLocalPart() + ", " + element.getType().getContentModel().getMinOccurs() + ", " + element.getType().getContentModel().getMaxOccurs() + ", " + theDetails.output() + "," + isMsgValueStored() + "," + (isMsgValueStored() ? getMessageValue() : " "));
                    clearMessageValue();
...
//                    }
                    ...
                    System.out.println(outputLine + "," + elementPath + "/" + element.getName().getLocalPart() + "," + element.getType().getBaseType().getName().getLocalPart() + ", " + element.getType().getContentModel().getIntMinOccurs() + ", " + element.getType().getContentModel().getMaxOccurs() + ", " + theDetails.output() + "," + isMsgValueStored() + "," + (isMsgValueStored() ? getMessageValue() : ""));
                    writeResults(outputLine + "," + elementPath + "/" + element.getName().getLocalPart() + "," + element.getType().getBaseType().getName().getLocalPart() + ", " + element.getType().getContentModel().getIntMinOccurs() + ", " + element.getType().getContentModel().getMaxOccurs() + ", " + theDetails.output() + "," + isMsgValueStored() + "," + (isMsgValueStored() ? getMessageValue() : " "));
                    clearMessageValue();
                }
...
//X                    System.out.println("   **** Not Removing Element  @ array index=" +(level-1) + "  level = "+level+"  Array Size ="+elementPathList.size());
    ...
    private void writeResults(String entry) {
        elementRecords.add(entry);
    }
...
//        theDatabase.queryNoResult("DELETE * FROM TMDDTestResultsTable WHERE TestType = 'MessageTest'");
        ...
        for (String entry : elementRecords) {

            String[] entryElement = entry.split(",");



            theDatabase.queryNoResult("INSERT INTO TMDDDesignDataDetail (elementName,Prefix,"
                    + "DataConcept,DataLevel,Message,ParentElement,ParentType,Path,BaseType,minOccurs,maxOccurs,minLength,maxLengh,minInclusive,maxInclusive,enumeration,valueStored,elementValue) VALUES ("
                    + "'" + entryElement[0] + "',"
                    + "'" + entryElement[1] + "',"
                    + "'" + entryElement[2] + "',"
                    + "'" + entryElement[3] + "',"
                    ...
                    + "'" + entryElement[15] + "',"
                    + entryElement[16] + ","
                    //                    + "'" + Boolean.getBoolean(entryElement[16]) + "',"
                    + "'" + entryElement[17] + "')");
