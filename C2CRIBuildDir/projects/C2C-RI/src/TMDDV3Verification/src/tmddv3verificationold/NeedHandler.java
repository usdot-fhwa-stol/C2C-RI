...
import tmddv3verificationold.testing.TestResult;
...
//            errorList.clear();
    ...
    /**
     * Represents a combination of a specific requirement and dataconcept item for a given need.
     */
    class DesignItem {
         ...
         * @param requirementIndex - the index of the specific requirement related to the need
         * @param reqDataConceptIndex - the index of the specific dataConcept related to the requirement
         */
        ...
        /**
         * 
         * @return the index for this dataconcept within the total list of related dataconcepts
         */
        ...
        /**
         *
         * @param reqDataConceptIndex - the index for this dataconcept within the total list of related dataconcepts
         */
        ...
        /**
         *
         * @return the index for this requirement within the total list of related requirements
         */
        ...
        /**
         *
         * @param requirementIndex - the index for this requirement within the total list of related requirements
         */
