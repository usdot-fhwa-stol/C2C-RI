...
import tmddv3verificationold.utilities.OperationSpecification;
...
public class DesignDetail {
    ...
    public DesignDetail(String wsdlFile) {
        ...
        for (int ii = 0; ii < globalElems.length; ii++) {
            ...
            System.out.println(msgName + "," + globalElems[ii].getSourceName().substring(globalElems[ii].getSourceName().lastIndexOf("/") + 1) + ",message");
            DesignElement theElement = new DesignElement();
...
//                                                }
//                                            } else {
                                    System.out.println(elementIndex + "," + messageType.getName().getLocalPart() + "," + (jj + 1) + "," + frameList[jj].getName().getLocalPart() + "," + type + "," + (frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame") + "," + "" + "," + frameList[jj].getMinOccurs() + "," + frameList[jj].getType().getContentModel().getMaxOccurs() + "," + frameList[jj].getType().getContentModel().getParticleChild(0).getName().getLocalPart());
                        DesignElement thisElement = new DesignElement();
                        ...
                        messageElement.getSubElements().add(thisElement);
                            ...
                            if (frameList[jj].getType() != null) {
                                ...
                                //                                   ex1.printStackTrace();
                                System.out.println(elementIndex + "," + messageType.getName().getLocalPart() + "," + (jj + 1) + "," + frameList[jj].getName().getLocalPart() + "," + type + "," + (frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame") + ",");
                        DesignElement thisElement = new DesignElement();
                        thisElement.setElementName(type);
                        thisElement.setElementType((frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame"));
                        thisElement.setReferenceName(messageElement.getReferenceName()+"\\"+frameList[jj].getName().getLocalPart());
...
//                                    System.out.println(ii + "," + msgType + "," + (jj + 1) + "Element:  **** ERROR Couldn't handle this one At ALL!!!");
                                ...
                                if (frameList[jj].getParticleType() == SchemaParticle.CHOICE) {
                                    ...
                                    for (SchemaParticle thisParticle : theParticles) {
                                        if ((thisParticle.getType() != null) && (thisParticle.getType().getName() != null)) {
                                            type = thisParticle.getType().getName().getLocalPart();
                                            System.out.println(elementIndex + "," + messageType.getName().getLocalPart() + "," + (jj + 1) + "," + thisParticle.getName().getLocalPart() + "," + type + "," + (thisParticle.getType().isSimpleType() ? "data-element" : "data-frame") + ",");
                        DesignElement thisElement = new DesignElement();
                        thisElement.setElementName(type);
                        thisElement.setElementType((frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame"));
                        ...
                        messageElement.getSubElements().add(thisElement);
                                            ...
                                            System.out.println(elementIndex + "," + messageType.getName().getLocalPart() + "," + (jj + 1) + "," + thisParticle.getName().getLocalPart() + ",UNKNOWN," + (thisParticle.getType().isSimpleType() ? "data-element" : "data-frame") + ",");
                        DesignElement thisElement = new DesignElement();
                        ...
                        try {
                            ...
                            if (element.getType().isAnonymousType()) {
                                ...
                                for (SchemaParticle thisParticle : thisParticleTry) {
                                    ...
                                    //                                                }
                                    //                                            } else {
                                    System.out.println(elementIndex + "," + frameType.getName().getLocalPart() + "," + (jj + 1) + "," + frameList[jj].getName().getLocalPart() + "," + type + "," + (frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame") + "," + "" + "," + frameList[jj].getMinOccurs() + "," + frameList[jj].getType().getContentModel().getMaxOccurs() + "," + frameList[jj].getType().getContentModel().getParticleChild(0).getName().getLocalPart());
                        DesignElement thisElement = new DesignElement();
                        thisElement.setElementName(type);
                        thisElement.setElementType((frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame"));
//                        thisElement.setReferenceName(messageElement.getReferenceName()+"\\"+frameList[jj].getName().getLocalPart());
                        ...
                        messageElement.getSubElements().add(thisElement);
                            ...
                            if (frameList[jj].getType() != null) {
                                type = frameList[jj].getType().getBaseType().getName().getLocalPart();
                                //                                   ex1.printStackTrace();
                                System.out.println(elementIndex + "," + frameType.getName().getLocalPart() + "," + (jj + 1) + "," + frameList[jj].getName().getLocalPart() + "," + type + "," + (frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame") + ",");
                        DesignElement thisElement = new DesignElement();
                        thisElement.setElementName(type);
                        thisElement.setElementType((frameList[jj].getType().isSimpleType() ? "data-element" : "data-frame"));
                        thisElement.setReferenceName(messageElement.getReferenceName()+"\\"+frameList[jj].getName().getLocalPart());
                        messageElement.getSubElements().add(thisElement);
                                ...
                                if (frameList[jj].getParticleType() == SchemaParticle.CHOICE) {
                                    ...
                                    for (SchemaParticle thisParticle : theParticles) {
                                        if ((thisParticle.getType() != null) && (thisParticle.getType().getName() != null)) {
                                            type = thisParticle.getType().getName().getLocalPart();
                                            System.out.println(elementIndex + "," + frameType.getName().getLocalPart() + "," + (jj + 1) + "," + thisParticle.getName().getLocalPart() + "," + type + "," + (thisParticle.getType().isSimpleType() ? "data-element" : "data-frame") + ",");
                       DesignElement thisElement = new DesignElement();
                        thisElement.setElementName(type);
                        ...
                        messageElement.getSubElements().add(thisElement);
                                            ...
                                            System.out.println(elementIndex + "," + frameType.getName().getLocalPart() + "," + (jj + 1) + "," + thisParticle.getName().getLocalPart() + ",UNKNOWN," + (thisParticle.getType().isSimpleType() ? "data-element" : "data-frame") + ",");
                        DesignElement thisElement = new DesignElement();
                        thisElement.setElementName("Unknown");
                        thisElement.setElementType((thisParticle.getType().isSimpleType() ? "data-element" : "data-frame"));
                        thisElement.setReferenceName(messageElement.getReferenceName()+"\\"+thisParticle.getName().getLocalPart());
