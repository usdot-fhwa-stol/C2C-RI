 ...
 * </source></pre>
 * 
 * @jameleon.function name="test-case-requirement"
 */
public class TestCaseRequirementTag extends AbstractTestCaseDocAttribute {
    
    protected void setTestCaseValue(String text){
        tct.getTestCase().setTestCaseRequirement(text);
    }
}
