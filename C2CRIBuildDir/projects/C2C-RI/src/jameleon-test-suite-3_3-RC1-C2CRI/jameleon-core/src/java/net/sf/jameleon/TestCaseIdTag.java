...
/**
 * Describes a unique id of the test case. Can be used to link
 ...
 * </source></pre>
 * 
 * @jameleon.function name="test-case-id"
 */
public class TestCaseIdTag extends AbstractTestCaseDocAttribute {
    
    protected void setTestCaseValue(String text){
        tct.getTestCase().setTestCaseId(text);
    }
}
