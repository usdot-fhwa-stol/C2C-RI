...
import net.sf.jameleon.ParamValueTag;
 ...
 * </source></pre>
 *
 * @jameleon.function name="sql-param-value"
 */
public class SqlParamValueTag extends ParamValueTag {
    
    protected void validateParentTag() throws JellyTagException{
        Tag tag = getParent();
        if ( ! (tag instanceof SqlParamTag) ) {
            throw new JellyTagException("This tag can only be imbedded in a sql-param tag.");
        }
    }
