...
/**
 * Describes a bug for a test case. To provide a link in the test
 ...
 * </source></pre>
 * 
 * @jameleon.function name="test-case-bug"
 */
public class TestCaseBugTag extends AbstractTestCaseDocAttribute {
    
    protected void setTestCaseValue(String text){
        tct.getTestCase().addBug(text);
    }
}
