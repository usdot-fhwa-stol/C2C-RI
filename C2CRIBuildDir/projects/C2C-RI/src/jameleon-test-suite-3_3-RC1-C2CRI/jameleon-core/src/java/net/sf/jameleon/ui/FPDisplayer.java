...
/**
 * Used to communicate with the functional point editor
 * of the UI
 */
public interface FPDisplayer{

    /**
     * Sends the provided FunctionalPoint to the UI that represents
     * the functional point.
     * @param fp - the FunctionalPoint to send to the UI
     */
