 ...
 * @jameleon.function name="mock-jameleon-tag-support2" type="action"
 * @jameleon.step step 1
 * @jameleon.step step 2
 **/
public class DummyJameleonTagSupport2 extends JameleonTagSupport {
    /**
     * A Required #
    ...
    public DummyJameleonTagSupport2(){
        super();
