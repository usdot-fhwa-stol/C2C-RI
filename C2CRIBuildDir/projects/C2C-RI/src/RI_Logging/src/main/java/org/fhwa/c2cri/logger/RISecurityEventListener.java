...
/**
 * Provides a security event listener for the processing of digitally signed log files.
 * 
 * @author TransCore ITS, LLC
 */
public class RISecurityEventListener implements SecurityEventListener {
