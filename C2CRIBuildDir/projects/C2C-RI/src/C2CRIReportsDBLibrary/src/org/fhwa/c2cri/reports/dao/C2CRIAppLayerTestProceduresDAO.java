...
/**
 * Provides support for the C2CRI_AppLayerTestProcedures Table.
 *
 * @author TransCore ITS
 */
public class C2CRIAppLayerTestProceduresDAO extends ReportsDAO {

    // Keep a cache of C2CRIAppLayerTestProcedures objects.  To speed up processing they will all be written out in batches.
    private ArrayList<C2CRIAppLayerTestProcedure> storedTestProcedureList = new ArrayList<>();
    // The maximum number of objects to hold before writing them out.
    private int maxHold = 100;
    
    public C2CRIAppLayerTestProceduresDAO(File outdb) throws Exception {
     ...
     */
    public void insert(ArrayList<C2CRIAppLayerTestProcedure> testProcedureList) {
        try {
            ...
            for (C2CRIAppLayerTestProcedure testProcedure : testProcedureList) {
                int col = 1;
    ...
    /**
     * Store the provided test procedure data object.  If we've reached the maxHold value, write out the current records.
     * 
     * @param testProcedure the current test procedure data object.
     */
    public void insert(C2CRIAppLayerTestProcedure testProcedure) {
