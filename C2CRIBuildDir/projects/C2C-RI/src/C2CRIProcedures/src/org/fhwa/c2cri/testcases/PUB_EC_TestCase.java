 ...
 */
public class PUB_EC_TestCase extends AbstractTMDDTestCase {

    public PUB_EC_TestCase(String needID, String dialog, String centerMode, boolean valid, String invalidCode, ArrayList<Variable>procedureVariables) {
