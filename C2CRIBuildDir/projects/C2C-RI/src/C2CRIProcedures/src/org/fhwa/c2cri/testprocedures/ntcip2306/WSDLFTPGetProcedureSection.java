 ...
 */
public class WSDLFTPGetProcedureSection extends TestProcedureSection {

    public WSDLFTPGetProcedureSection() {
        try {
        Variable wsdlNRTMVariable = new WSDLNRTMVariable("NTCIP2306_N3R11_WSDL_Request_Only_FTP_GET_Flag", "From the NTCIP 2306 NRTM (3.a)", "NRTM Flag for the FTP GET WSDL");
...
//                if (thisSpecification.getSection().startsWith("7.1")){
                   TestProcedureStep newStep = NTCIP2306ProcedureStepFactory.makeProcedureStep(NTCIP2306ProcedureStepFactory.FTP_GET_WSDL_SECTION_STEP_TYPE);
