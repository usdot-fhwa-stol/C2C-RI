 ...
 */
public class WSDLHTTPGetProcedureSection extends TestProcedureSection {

    public WSDLHTTPGetProcedureSection() {
        try {
        Variable wsdlNRTMVariable = new WSDLNRTMVariable("NTCIP2306_N2R6_WSDL_Request_Only_HTTP_GET_Flag", "From the NTCIP 2306 NRTM (2.a)", "NRTM Flag for the HTTP GET WSDL");
...
//                if (thisSpecification.getSection().startsWith("7.1")){
                   TestProcedureStep newStep = NTCIP2306ProcedureStepFactory.makeProcedureStep(NTCIP2306ProcedureStepFactory.HTTP_GET_WSDL_SECTION_STEP_TYPE);
