 ...
 */
public class SUB_EC_TestCase extends AbstractTMDDTestCase {

    public SUB_EC_TestCase(String needID, String dialog, String centerMode, boolean valid, String invalidCode, ArrayList<Variable>procedureVariables) {
