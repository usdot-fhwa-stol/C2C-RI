 ...
 */
public class WSDLSOAPRRSectionTestStep extends TestProcedureStep {

    private NTCIP2306Specification relatedSpecification;

    public WSDLSOAPRRSectionTestStep() {
        this.setDescription("IF NTCIP2306_N1R1_WSDL_Request_Response_Flag is equal to True CONTINUE; OTHERWISE skip the following substeps.");
        this.setResults("NA");
...
//                   newStep.setPrimaryStepId(getId());
    ...
    public void setStartStepNumber(Integer stepNumber) {
        System.out.println("WSDLSOAPRRSectionTestStep:  Step Number "+stepNumber);
        ...
        for (Section thisSubsection : getSubSteps()){
               ...
               System.out.println("WSDLSOAPRRSectionTestStep:  Set Primary Step Number to "+stepNumber+" for step "+((TestProcedureStep)thisSubsection).getId());
         }
...
//        theList.add(this);
    ...
    public String getScriptContent() {
        ...
        result = "<testStep functionId=\"Step "+this.getId()+" If NTCIP2306_N1R1_WSDL_Request_Response_Flag is equal to True CONTINUE; OTHERWISE skip the following substeps.\" />\n<jl:if test=\"${NTCIP2306_N1R1_WSDL_Request_Response_Flag.isTrue()}\" >\n"+subSteps+"</jl:if>\n";
        return result;
    }
}
