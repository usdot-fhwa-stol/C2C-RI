 ...
 */
public class WSDLFTPGetSectionTestStep extends TestProcedureStep {

    private NTCIP2306Specification relatedSpecification;

    public WSDLFTPGetSectionTestStep() {
        this.setDescription("IF NTCIP2306_N3R11_WSDL_Request_Only_FTP_GET_Flag is equal to True CONTINUE; OTHERWISE skip the following substeps.");
        this.setResults("NA");
        ...
        try{
            ...
            for (NTCIP2306Specification thisSpecification : wsdlSpecificationList) {
                if (thisSpecification.getSection().startsWith("9.1")){
...
//                   newStep.setPrimaryStepId(getId());
    ...
    public void setStartStepNumber(Integer stepNumber) {
        System.out.println("WSDLFTPGetSectionTestStep:  Step Number "+stepNumber);
        ...
        for (Section thisSubsection : getSubSteps()){
               ...
               System.out.println("WSDLFTPGetSectionTestStep:  Set Primary Step Number to "+stepNumber+" for step "+((TestProcedureStep)thisSubsection).getId());
         }
...
//        theList.add(this);
    ...
    public String getScriptContent() {
        ...
        result = "<testStep functionId=\"Step "+this.getId()+" IF NTCIP2306_N3R11_WSDL_Request_Only_FTP_GET_Flag is equal to True CONTINUE; OTHERWISE skip the following substeps.\"    passfailResult=\"False\" />\n<jl:if test=\"${NTCIP2306_N3R11_WSDL_Request_Only_FTP_GET_Flag}\" >\n"+subSteps+"</jl:if>\n";
        return result;
    }
}
