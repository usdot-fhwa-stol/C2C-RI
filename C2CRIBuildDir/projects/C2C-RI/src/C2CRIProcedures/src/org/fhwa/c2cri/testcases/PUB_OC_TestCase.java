 ...
 */
public class PUB_OC_TestCase extends AbstractTMDDTestCase {

    public PUB_OC_TestCase(String needID, String dialog, String centerMode, boolean valid, String invalidCode, ArrayList<Variable>procedureVariables) {
