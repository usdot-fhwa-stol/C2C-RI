 ...
 */
public class SUB_OC_TestCase extends AbstractTMDDTestCase {

    public SUB_OC_TestCase(String needID, String dialog, String centerMode, boolean valid, String invalidCode, ArrayList<Variable>procedureVariables) {
