 ...
 */
public class DialogErrorContentVerifyTestStep extends TestProcedureStep{
    private String dialog;
    private String dialogVariableName;

    public DialogErrorContentVerifyTestStep(String dialog){
        this.dialog = dialog;
        ...
        this.setDescription("IF "+dialogVariableName+" is equal to TRUE THEN CONTINUE, OTHERWISE skip the following substeps.  If a verification step fails, then test execution will proceed at the next subsequent Post Condition step, if present.  Otherwise, test execution will proceed to the final Exit step.");
        this.setResults("NA");
    }
