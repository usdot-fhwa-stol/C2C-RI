 ...
 */
public class RequiredErrorValueVerifyTestSubStep extends TestProcedureStep{
    private MessageDetailDesignElement designElement;
    private String requirementID;
    private boolean relatedToPublication;
    private String requiredValue;

    public RequiredErrorValueVerifyTestSubStep(MessageDetailDesignElement theDesignElement, Integer subStepNumber, String requirementID, boolean relatedToPublication, String requiredValue){
