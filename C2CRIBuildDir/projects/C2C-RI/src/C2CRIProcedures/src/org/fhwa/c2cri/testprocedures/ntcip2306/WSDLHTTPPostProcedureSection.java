 ...
 */
public class WSDLHTTPPostProcedureSection extends TestProcedureSection {

    public WSDLHTTPPostProcedureSection() {
        try {
        Variable wsdlNRTMVariable = new WSDLNRTMVariable("NTCIP2306_N2R7_WSDL_Request_Response_HTTP_POST_Flag", "From the NTCIP 2306 NRTM (2.b)", "NRTM Flag for the HTTP POST WSDL");
...
//                if (thisSpecification.getSection().startsWith("7.1")){
                   TestProcedureStep newStep = NTCIP2306ProcedureStepFactory.makeProcedureStep(NTCIP2306ProcedureStepFactory.HTTP_POST_WSDL_SECTION_STEP_TYPE);
