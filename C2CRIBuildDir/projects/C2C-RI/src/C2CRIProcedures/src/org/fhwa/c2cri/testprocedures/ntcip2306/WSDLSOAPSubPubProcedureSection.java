 ...
 */
public class WSDLSOAPSubPubProcedureSection extends TestProcedureSection {

    public WSDLSOAPSubPubProcedureSection() {
        try {
        Variable wsdlNRTMVariable = new WSDLNRTMVariable("NTCIP2306_N1R2_WSDL_Subscription_Publication_Flag", "From the NTCIP 2306 NRTM (1.b)", "NRTM Flag for the SOAP Subscription-Publication WSDL");
...
//                if (thisSpecification.getSection().startsWith("7.1")){
                   TestProcedureStep newStep = NTCIP2306ProcedureStepFactory.makeProcedureStep(NTCIP2306ProcedureStepFactory.SOAP_SUBPUB_WSDL_SECTION_STEP_TYPE);
