...
/**
 * This class represents the set of Section Signal Timing Pattern Inventory entity information for the
 * center. The information that is maintained is described in TMDD Volume II -
 * Section 3.2.2.2.
 *
 * @author TransCore ITS, LLC Created: Jan 31, 2016
 */
public class SectionSignalTimingPatternInventory extends TMDDDefaultEntityDataType{

    public SectionSignalTimingPatternInventory(EntityEmulationData.EntityDataType entityDataType){
