...
/**
 * This class represents the set of Gate Status entity information for the
 * center. The information that is maintained is described in TMDD Volume II -
 * Section 3.2.2.2.
 *
 * @author TransCore ITS, LLC Created: Jan 31, 2016
 */
public class GateStatus extends TMDDDefaultEntityDataType{

    public GateStatus(EntityEmulationData.EntityDataType entityDataType){
