...
/**
 * This class represents the set of ESS Inventory entity information for the
 * center. The information that is maintained is described in TMDD Volume II -
 * Section 3.2.2.2.
 *
 * @author TransCore ITS, LLC Created: Jan 31, 2016
 */
public class ESSInventory extends TMDDDefaultEntityDataType{

    public ESSInventory(EntityEmulationData.EntityDataType entityDataType){
