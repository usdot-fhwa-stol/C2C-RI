 ...
 */
public class DlIntersectionSignalTimingPatternInventoryRequest extends DialogProcessor {

    public DlIntersectionSignalTimingPatternInventoryRequest() {
        this.setDialogName("dlIntersectionSignalTimingPatternInventoryRequest");
    ...
    protected void preprocessing(EntityEmulationRequests.EntityRequestMessageType requestMessageType, MessageSpecification requestMessage) throws TMDDCenterDoesNotSupportMessageError, TMDDMissingInformationError {
        if (!requestMessage.containsMessageOfType(EntityEmulationRequests.EntityRequestMessageType.INTERSECTIONSIGNALTIMINGPATTERNINVENTORYREQUESTMSG.relatedMessage())) {
            throw new TMDDCenterDoesNotSupportMessageError("The message received did not contain the correct message type for the dlIntersectionSignalTimingPatternInventoryRequest dialog.");
        }
