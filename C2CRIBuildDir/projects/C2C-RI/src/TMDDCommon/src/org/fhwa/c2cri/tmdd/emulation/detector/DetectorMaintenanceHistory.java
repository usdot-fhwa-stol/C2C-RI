 ...
 */
public class DetectorMaintenanceHistory extends TMDDDefaultEntityDataType{

    public DetectorMaintenanceHistory(EntityEmulationData.EntityDataType entityDataType){
