 ...
 */
package org.fhwa.c2cri.tmdd.emulation.intersection.dialogs;
 ...
 */
public class DlIntersectionSignalTimingPatternInventorySubscription extends DialogProcessor {

    public DlIntersectionSignalTimingPatternInventorySubscription() {
        this.setDialogName("dlIntersectionSignalTimingPatternInventorySubscription");
    ...
    protected void preprocessing(EntityEmulationRequests.EntityRequestMessageType requestMessageType, MessageSpecification requestMessage) throws TMDDCenterDoesNotSupportMessageError, TMDDMissingInformationError {
        if (!requestMessage.containsMessageOfType(EntityEmulationRequests.EntityRequestMessageType.INTERSECTIONSIGNALTIMINGPATTERNINVENTORYREQUESTMSG.relatedMessage())) {
            throw new TMDDCenterDoesNotSupportMessageError("The message received did not contain the correct message type for the dlIntersectionSignalTimingPatternInventorySubscription dialog.");
        }
    ...
    protected MessageSpecification generateResponse(MessageSpecification requestMessage, EntityEmulationData.EntityDataType entityDataType, EntityDataInformationCollector dataCollector, EntityCommandProcessor commandProcessor, boolean isPublication) throws NoMatchingDataException, EntityEmulationException {
        ...
        MessageSpecification responseMsg = TMDDMessageProcessor.processIntersectionSignalTimingPatternInventoryRequestMsg(requestMessage, entityDataType, dataCollector, false);
        return responseMsg;
    }
