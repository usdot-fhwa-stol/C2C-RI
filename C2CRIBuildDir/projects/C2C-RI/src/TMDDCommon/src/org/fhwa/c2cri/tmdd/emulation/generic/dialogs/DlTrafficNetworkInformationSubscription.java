 ...
 */
public class DlTrafficNetworkInformationSubscription extends DialogProcessor {

    public DlTrafficNetworkInformationSubscription() {
        this.setDialogName("dlTrafficNetworkInformationSubscription");
    ...
    protected void preprocessing(EntityEmulationRequests.EntityRequestMessageType requestMessageType, MessageSpecification requestMessage) throws TMDDCenterDoesNotSupportMessageError, TMDDMissingInformationError {
        if (!requestMessage.containsMessageOfType(EntityEmulationRequests.EntityRequestMessageType.TRAFFICNETWORKINFORMATIONREQUESTMSG.relatedMessage())) {
            throw new TMDDCenterDoesNotSupportMessageError("The message received did not contain the correct message type for the dlTrafficNetworkInformationSubscription dialog.");
        }

//        if ((msgDeviceInformationType.equals("2") || msgDeviceInformationType.equals("device status"))
//                && (msgDeviceType.equals("3") || msgDeviceType.equals("dynamic message sign"))) {
//
//        } else {
//            throw new TMDDMissingInformationError("The message received did not contain correct device-type and device-information-type values for the dlDMSStatusRequest dialog.");
//        }
    }
