...
public class TMDDMessageDetailGeneratorModified {
    ...
    public static void main(String[] args) {
        ...
        String[] tempargs = new String[12];
        tempargs[0] = "-name";
        tempargs[1] = "deviceInformationRequestMsg";
        tempargs[2] = "-dl";
//        tempargs[3] = "C:\\Inout\\TMDD Schemas v9.0\\TMDD.xsd";
  //      tempargs[3] = "c:\\inout\\TMDDSchemasv301d6\\TMDD.xsd";
  //      tempargs[4] = "c:\\inout\\TMDDSchemasv301d6\\C2C.xsd";
  //      tempargs[5] = "c:\\inout\\TMDDSchemasv301d6\\NTCIP-References.xsd";
  //      tempargs[6] = "c:\\inout\\TMDDSchemasv301d6\\LRMS-Local-02-00-00.xsd";
  //      tempargs[7] = "c:\\inout\\TMDDSchemasv301d6\\LRMS-Adopted-02-00-00.xsd";
  //      tempargs[8] = "c:\\inout\\TMDDSchemasv301d6\\ITIS-Local-03-00-02.xsd";
  //      tempargs[9] = "c:\\inout\\TMDDSchemasv301d6\\ITIS-Adopted-03-00-02.xsd";


        tempargs[3] = "C:\\Inout\\TMDDv3.1\\TMDD.xsd";
        tempargs[4] = "C:\\Inout\\TMDDv3.1\\ATIS.xsd";
        tempargs[5] = "C:\\Inout\\TMDDv3.1\\C2C.xsd";
        tempargs[6] = "C:\\Inout\\TMDDv3.1\\NTCIP-References.xsd";
        tempargs[7] = "C:\\Inout\\TMDDv3.1\\LRMS-Local-02-00-00.xsd";
        tempargs[8] = "C:\\Inout\\TMDDv3.1\\LRMS-Adopted-02-00-00.xsd";
        tempargs[9] = "C:\\Inout\\TMDDv3.1\\ITIS-Local-03-00-02.xsd";
        tempargs[10] = "C:\\Inout\\TMDDv3.1\\ITIS-Adopted-03-00-02.xsd";
        tempargs[11] = "C:\\Inout\\TMDDv3.1\\TMDDvX.xsd";
//        String wsdlFileName = "c:\\inout\\tmp\\TMDDv301\\tmdd-fixed.wsdl";
        ...
        ConceptMapper theMapper = ConceptMapper.getMapper();
        for (int ii = 0; ii < globalTypes.length; ii++) {
            String msgType = globalTypes[ii].getName().getLocalPart();

            theMapper.setConcept(msgType, (globalTypes[ii].isSimpleType()&&!globalTypes[ii].getBaseType().getName().getLocalPart().equals("anyType")?"data-element":"data-frame"));
            System.out.println(" MsgType ="+msgType+ "  Type: "+(globalTypes[ii].isSimpleType()&&!globalTypes[ii].getBaseType().getName().getLocalPart().equals("anyType")?"data-element":"data-frame"));
...
//        System.out.println("processElement,Prefix,type,level,Message,Parent,ParentType,Path");
        System.out.println("id,elementName,Prefix,DataConcept,DataConceptType,Level,Message,ParentElement,ParentType,Path,BaseType,minOccurs,maxOccurs,minLength,maxLength,minInclusive,maxInclusive,enumeration,valueStored,value,isList,edited,comment");

        MessagePathMaker theMaker = MessagePathMaker.getMaker();
