...
/**
 * The Class WSDLTest_8_1_2_6_Post.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_2_6_Post implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_2_6_ post.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_2_6_Post(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.1.2.6");
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:binding[exists(http:binding)]/wsdl:operation/http:operation";
            xmlc.toStartDoc();
            ...
            while (xmlc.hasNextSelection()) {
                ...
                if (xmlc.toNextSibling()) {
                    ...
                    if (!inputElementFound) {
                        ...
                        inputElementMissingErrors.add("Binding " + bindingName + " contains an operation element " + operation + " that does not contain an input element after http:operation. ");
                        xmlc.pop();
                    }
        ...
        assertion.setTestAssertionPrescription("The http:operation tag shall be followed by the input /input tag set. ");
        return assertion;
    }
