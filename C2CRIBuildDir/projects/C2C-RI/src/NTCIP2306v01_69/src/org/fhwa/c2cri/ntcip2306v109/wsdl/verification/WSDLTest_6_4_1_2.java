...
/**
 * The Class WSDLTest_6_4_1_2.
 *
 * @author TransCore ITS, LLC Last Updated: 1/8/2014
 */
public class WSDLTest_6_4_1_2 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_6_4_1_2.
     *
     ...
     */
    public WSDLTest_6_4_1_2(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("6.4.1.2");
        ...
        if (wsdlSpec.isSchemaDocumentsExist()) {
            ...
            try {
                ...
                if (misnamedMessages.isEmpty() && missingOperationMessages.isEmpty() && missingSchemaMessages.isEmpty()) {
                    ...
                    // Allow the ambiguous Schema errors to still allow the test to pass.
