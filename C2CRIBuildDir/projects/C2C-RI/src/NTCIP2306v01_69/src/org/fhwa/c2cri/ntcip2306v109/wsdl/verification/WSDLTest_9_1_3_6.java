...
/**
 * The Class WSDLTest_9_1_3_6.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_9_1_3_6 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_9_1_3_6.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_9_1_3_6(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("9.1.3.6");
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:binding[exists(ftp:binding)]/wsdl:operation[exists(ftp:operation)]/wsdl:output[not(preceding-sibling::wsdl:input)]";
            xmlc.toStartDoc();
            ...
            xPathStatement = "/wsdl:definitions/wsdl:binding[exists(ftp:binding)]/wsdl:operation[exists(ftp:operation)]/wsdl:input[not(exists(following-sibling::wsdl:output))and not(exists(preceding-sibling::wsdl:output))]";
            xmlc.toStartDoc();
            xmlc.selectPath(xqNamespace + "$this/" + xPathStatement);
