...
/**
 * The Class WSDLTest_8_3_1_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_3_1_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_3_1_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_3_1_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.3.1.1");
        try {
                    ...
                    do {
                        if (xmlc.getName().getLocalPart().equals("address") && xmlc.getName().getNamespaceURI().equals("http://schemas.xmlsoap.org/wsdl/http/")){
                            ...
                            if (!locationAttributePresent){
                                locationAttributeErrors.add("The location attribute for httpp:address tag in a port was not set for service " + serviceName);
                            }
                            xmlc.pop();
        ...
        assertion.setTestAssertionPrescription("The XML HTTP endpoint uses the http:address tag to specify an endpoint rather than the soap:address tag. ");
        return assertion;
    }
}
