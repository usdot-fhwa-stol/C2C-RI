...
/**
 * The Class WSDLTest_9_1_3_2.
 *
 * @author TransCore ITS
 */
public class WSDLTest_9_1_3_2 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_9_1_3_2.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_9_1_3_2(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("9.1.3.2");
        try {
        ...
        assertion.setTestAssertionPrescription("The operation tag shall be followed by the ftp:operation tag. ");
        return assertion;
    }
}
