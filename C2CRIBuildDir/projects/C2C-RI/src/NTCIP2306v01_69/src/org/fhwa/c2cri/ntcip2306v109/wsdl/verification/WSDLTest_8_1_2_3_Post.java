...
/**
 * The Class WSDLTest_8_1_2_3_Post.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_2_3_Post implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_2_3_ post.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_2_3_Post(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.1.2.3");
        try {
            ...
            ArrayList<String> getRelatedOperations = wsdlSpec.getXMLHTTPOperations("POST");
            ...
            if (!getRelatedOperations.isEmpty() && missingOperationDefinitions.isEmpty()){
                ...
                String errorMessage = getRelatedOperations.isEmpty() ? "No instances of operations related to a HTTP POST Service were found. \n" : "";
        ...
        assertion.setTestAssertionPrescription("The operation name shall match the operation as specified in the portType section of the WSDL for each operation (file) supported by the center. ");
        return assertion;
    }
}
