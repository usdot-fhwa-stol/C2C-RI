...
/**
 * The Class WSDLTest_7_2_4_4.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_7_2_4_4 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_7_2_4_4.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_7_2_4_4(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("7.2.4.4");
        try {
        ...
        assertion.setTestAssertionPrescription("Following the port tag, a soap:address tag shall be placed. The location attribute of the soap:address tag shall specify a fake (place holder ) service endpoint of the SOAP service, which contains the subscriber callback listener. However, to support valid WSDL, the soap:address tag must be included. The subscriber shall provide an end point at run-time as described in Section 7.1.2 covering Subscription. ");
        return assertion;
    }
}
