...
/**
 * The Class WSDLTest_8_1_1_3.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_1_3 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_1_3.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_1_3(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.1.1.3");
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:portType[count(child::wsdl:operation)=1]/wsdl:operation[exists(wsdl:input)][not(exists(wsdl:output))]";
            xmlc.toStartDoc();
            ...
            if (xmlc.hasNextSelection()) {
                ...
                assertion.setTestResultDescription("No instances of portType tags with a single one-way operation were found in the WSDL file.");
            }
            xmlc.dispose();
        ...
        assertion.setTestAssertionPrescription("The operation shall be a one-way operation between the data provider center and the external center (data consumer).");
        return assertion;
    }
}
