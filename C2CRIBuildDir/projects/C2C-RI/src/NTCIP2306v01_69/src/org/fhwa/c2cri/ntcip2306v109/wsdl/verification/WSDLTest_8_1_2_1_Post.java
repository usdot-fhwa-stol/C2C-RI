...
/**
 * The Class WSDLTest_8_1_2_1_Post.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_2_1_Post implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_2_1_ post.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_2_1_Post(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.1.2.1");
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:binding[child::http:binding/@verb=\"POST\"]";
            xmlc.toStartDoc();
            ...
            if (xmlc.hasNextSelection()) {
                ...
                assertion.setTestResultDescription("No instances of binding tags followed by http:binding tags were found matching the HTTP GET subprofile.");
            }
            xmlc.dispose();
        ...
        assertion.setTestAssertionPrescription("The binding tag shall be followed by a http:binding tag. ");
        return assertion;
    }
}
