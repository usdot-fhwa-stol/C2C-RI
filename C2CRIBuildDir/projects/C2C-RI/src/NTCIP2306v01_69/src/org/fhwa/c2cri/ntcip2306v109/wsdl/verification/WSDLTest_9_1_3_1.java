...
/**
 * The Class WSDLTest_9_1_3_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_9_1_3_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_9_1_3_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_9_1_3_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("9.1.3.1");
        try {
            ...
            xPathStatement = "/wsdl:definitions/wsdl:binding[exists(ftp:binding)]/wsdl:operation";
            xmlc.toStartDoc();
            xmlc.selectPath(xqNamespace + "$this/" + xPathStatement);
            ...
            if (operationMissingErrors.isEmpty() && instancesFound) {
                ...
                String errorMessage = !instancesFound ? "No instances of the binding tag followed by a ftp:binding element and an operation tag were found. \n" : "";
