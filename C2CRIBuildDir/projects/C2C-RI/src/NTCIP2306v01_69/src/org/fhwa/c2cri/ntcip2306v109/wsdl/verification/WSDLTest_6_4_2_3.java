...
/**
 * The Class WSDLTest_6_4_2_3.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_6_4_2_3 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_6_4_2_3.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_6_4_2_3(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("6.4.2.3");
        ...
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:message[child::wsdl:part/@element=\"c2c:c2cMessageSubscription\"]/@name";
            xmlc.toStartDoc();
            ...
            for (String thisDialogMessage : dialogMessageList) {
                if (definedMessageList.contains(thisDialogMessage)) {
                    ...
                    while (xmlc.hasNextSelection()) {
                        xmlc.toNextSelection();
                        if (!xmlc.getTextValue().equals("c2c:c2cMessageSubscription")) {
            ...
            if (incorrectAttributeMessages.isEmpty() && missingPartMessages.isEmpty()&&unrecognizedMessageList.isEmpty()) {
                ...
                String errorDescription = missingPartsFound.equals("") ? "" : "\nSubscription messages that have missing parts: " + missingPartsFound;
        ...
        assertion.setTestAssertionPrescription("The message shall have 2 parts. The name attribute of the first message part shall always be c2cMsgAdmin, and the elemen attribute c2c:c2cMessageSubscription. ");
        return assertion;
    }
}
