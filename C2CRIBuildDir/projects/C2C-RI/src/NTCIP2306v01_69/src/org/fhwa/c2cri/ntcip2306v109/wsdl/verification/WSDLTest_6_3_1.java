...
/**
 * The Class WSDLTest_6_3_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_6_3_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_6_3_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_6_3_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("6.3.1");
        try {
            ...
            String xPathStatement = "exists(/wsdl:definitions/child::wsdl:types)";
            xmlc.toStartDoc();
        ...
        assertion.setTestAssertionPrescription("The type section shall begin with the types tag ");
        return assertion;
    }
}
