...
/**
 * The Class WSDLTest_8_1_1_2.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_1_2 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_1_2.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_1_2(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.1.1.2");
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:portType[count(child::wsdl:operation)=1]/wsdl:operation[exists(wsdl:input)]";
            xmlc.toStartDoc();
            ...
            if (xmlc.hasNextSelection()) {
                ...
                assertion.setTestResultDescription("No instances of portType tags with a single operation were found in the WSDL file.");
            }
            xmlc.dispose();
        ...
        assertion.setTestAssertionPrescription("The portType tag shall be followed by a single operation that maps to a specific file. ");
        return assertion;
    }
}
