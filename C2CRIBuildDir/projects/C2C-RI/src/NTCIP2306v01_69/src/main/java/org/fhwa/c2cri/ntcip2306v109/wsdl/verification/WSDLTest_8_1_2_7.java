...
/**
 * The Class WSDLTest_8_1_2_7.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_2_7 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_2_7.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_2_7(RIWSDL wsdlSpec, String wsdlURL) {
            ...
            while (xmlc.hasNextSelection()) {
                ...
                if (xmlc.toFirstChild()) {
                    ...
                    if (!httpUrlEncodedElementFound) {
                        ...
                        if (getRelatedOperations.contains(operation)){
