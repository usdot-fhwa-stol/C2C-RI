...
/**
 * The Class WSDLTest_7_1_2_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_7_1_2_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_7_1_2_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_7_1_2_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("7.1.2.1");
        try {
            ...
            if (xmlc.hasNextSelection()) {
                ...
                assertion.setTestResultDescription("No instances of the binding tag followed by a soap:binding tag were found.");
            }
        ...
        assertion.setTestAssertionPrescription("The binding tag shall be followed by a soap:binding tag. ");
        return assertion;
    }
}
