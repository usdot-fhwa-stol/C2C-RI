...
/**
 * The Class WSDLTest_8_1_2_2_Post.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_2_2_Post implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_2_2_ post.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_2_2_Post(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        try {
            ...
            if (xmlc.hasNextSelection()) {
                ...
                assertion.setTestResultDescription("No instances of binding tags followed by http:binding tags with the verb \"POST\" were found matching the HTTP POST subprofile.");
            }
            xmlc.dispose();
