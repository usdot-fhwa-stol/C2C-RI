...
/**
 * The Class WSDLTest_8_1_2_8.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_2_8 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_2_8.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_2_8(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        try {
            ...
            xPathStatement = "/wsdl:definitions/wsdl:binding[exists(http:binding)]/wsdl:operation[exists(http:operation)]/wsdl:input[not(exists(following-sibling::wsdl:output))and not(exists(preceding-sibling::wsdl:output))]";
            xmlc.toStartDoc();
            xmlc.selectPath(xqNamespace + "$this/" + xPathStatement);
