...
/**
 * The Class WSDLTest_9_1_4_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_9_1_4_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_9_1_4_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_9_1_4_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("9.1.4.1");
        try {
        ...
        assertion.setTestAssertionPrescription("The XML FTP endpoint uses the ftp:address tag to specify an endpoint rather than the soap:address tag.");
        return assertion;
    }
}
