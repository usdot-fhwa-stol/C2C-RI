...
public class WSDLTest_6_4_3_2 implements WSDLTest {

    RIWSDL wsdlSpec;
    String wsdlURL;

    public WSDLTest_6_4_3_2(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("6.4.3.2");
        if (wsdlSpec.isSchemaDocumentsExist()) {
            ...
            assertion.setTestResult("Failed");
            assertion.setTestResultDescription("Test could not be performed due to one or more schema files referenced by the WSDL file missing.");
        }
