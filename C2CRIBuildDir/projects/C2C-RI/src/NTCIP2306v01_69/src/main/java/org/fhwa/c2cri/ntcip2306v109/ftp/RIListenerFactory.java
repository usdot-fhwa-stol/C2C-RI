 ...
 */
public class RIListenerFactory {
     ...
     */
    public RIListenerFactory(Listener listener) {
    ...
    public Listener createListener() {
    	...
    	if(blockedAddresses != null || blockedSubnets != null) {
            return new RINioListener(serverAddress, port, implicitSsl, ssl,
     ...
     * @return The created listener
     */
    public Listener createListener(RIFtpHandler handler) {
    	try{
    		InetAddress.getByName(serverAddress);
    	}catch(UnknownHostException e){
    		throw new FtpServerConfigurationException("Unknown host",e);
	    ...
	    return new RINioListener(serverAddress, port, implicitSsl, ssl,
	        	dataConnectionConfig, idleTimeout, ipFilter, handler.getPath(), handler);
    	}
    }
