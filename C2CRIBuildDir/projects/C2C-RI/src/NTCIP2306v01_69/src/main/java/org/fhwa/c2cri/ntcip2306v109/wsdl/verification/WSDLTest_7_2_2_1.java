...
/**
 * The Class WSDLTest_7_2_2_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_7_2_2_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_7_2_2_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_7_2_2_1(RIWSDL wsdlSpec, String wsdlURL){
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("7.2.2.1");
        try {
        ...
        assertion.setTestAssertionPrescription("The portType tag shall be followed by a list of operations supported by the subscriber for listening for asynchronous SOAP message delivery. ");
        return assertion;
    }
