...
/**
 * The Class WSDLTest_8_1_2_10.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_2_10 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_2_10.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_2_10(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.1.2.10");
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:binding[exists(http:binding)]/wsdl:operation[exists(http:operation)  and (preceding-sibling::http:binding/@verb=\"GET\")]/wsdl:output";
            xmlc.toStartDoc();
            ...
            while (xmlc.hasNextSelection()) {
                ...
                if (xmlc.toFirstChild()) {
                    ...
                    if (!mimeContentElementFound) {
                        ...
                        bindingName = getParentBindingName(xmlc);
                        typeAttributeErrors.add("Binding " + bindingName + " contains an operation element " + operation + " which contains an output element whose soap:body element does not contain the use attribute. ");
                        xmlc.pop();
            ...
            if (mimeContentMissingErrors.isEmpty() &&typeAttributeErrors.isEmpty()&& instancesFound) {
        ...
        assertion.setTestAssertionPrescription("The valid type attribute of the mime:content tag shall be any MIME type. ");
        return assertion;
    }
