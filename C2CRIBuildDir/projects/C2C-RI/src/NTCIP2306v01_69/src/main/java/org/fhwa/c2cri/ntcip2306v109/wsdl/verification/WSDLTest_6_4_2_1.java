...
/**
 * The Class WSDLTest_6_4_2_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_6_4_2_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_6_4_2_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_6_4_2_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("6.4.2.1");
        ...
        try {
            ...
            while (xmlc.hasNextSelection()){
                ...
                if (!definedMessageList.contains(xmlc.getTextValue()))definedMessageList.add(xmlc.getTextValue());
            }
            ...
            for (String thisDialogMessage : dialogMessageList){
                if (definedMessageList.contains(thisDialogMessage)){
                    ...
                    if (!matchedToSchema)missingSchemaMessages.add(thisDialogMessage);
            ...
            if (missingOperationMessages.isEmpty() && missingSchemaMessages.isEmpty()){
        ...
        assertion.setTestAssertionPrescription("The message section shall specify all top-level messages defined in the XML Schema that apply to the project implementation and used as a subscription message.");
        return assertion;
    }
}
