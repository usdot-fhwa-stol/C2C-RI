...
/**
 * The Class WSDLTest_7_1_1_2.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_7_1_1_2 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_7_1_1_2.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_7_1_1_2(RIWSDL wsdlSpec, String wsdlURL){
     ...
     */
    public WSDLTest_7_1_1_2(RIWSDL wsdlSpec, String wsdlURL, boolean requestResponseTest){
        this.wsdlSpec = wsdlSpec;
        this.wsdlURL = wsdlURL;
    ...
    public TestAssertion perform() {
        ...
        try {
            ...
            if (soapOperationFound && nonStandardOperationNames.isEmpty()){
                ...
                String errorMessage = !soapOperationFound? "No operations supported by a SOAP Service were found listed under a parent portType tag.":"";
                ...
                } else {  // If there was a problem processing the schemas associated with the WSDL then indicate that this might be the cause of the problem.
                    errorMessage = errorMessage.concat("No operations supported by a SOAP Service were found listed under a parent portType tag." + "  This may be due to an error (" +this.wsdlSpec.getSchemaTypeError()+") processing the schema files associated with the WSDL.");                    
                }
