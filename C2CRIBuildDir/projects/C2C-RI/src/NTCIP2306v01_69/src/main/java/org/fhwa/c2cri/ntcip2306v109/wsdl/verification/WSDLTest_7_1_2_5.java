...
/**
 * The Class WSDLTest_7_1_2_5.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_7_1_2_5 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_7_1_2_5.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_7_1_2_5(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("7.1.2.5");
        try {
            ...
            if (xmlc.hasNextSelection()) {
                ...
                assertion.setTestResultDescription("No instances of the binding tag followed by an operation and soap:operation tag were found.");
            }
        ...
        assertion.setTestAssertionPrescription("The operation tag shall be followed by the soap:operation tag. ");
        return assertion;
    }
}
