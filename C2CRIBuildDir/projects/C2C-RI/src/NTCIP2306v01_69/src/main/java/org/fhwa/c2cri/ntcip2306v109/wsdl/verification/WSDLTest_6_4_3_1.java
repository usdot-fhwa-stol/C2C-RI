...
/**
 * The Class WSDLTest_6_4_3_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_6_4_3_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_6_4_3_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_6_4_3_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("6.4.3.1");
        if (wsdlSpec.isSchemaDocumentsExist()) {
            ...
            try {
                ...
                dialogMessageList = wsdlSpec.getDialogRelatedMessages("Update");
                ...
                if (missingOperationMessages.isEmpty() && missingSchemaMessages.isEmpty()) {
                    ...
                    errorDescription = errorDescription.concat(missingFromOperations.equals("") ? "" : "\nPublication messages not included in Message Section: " + missingFromOperations);
        ...
        assertion.setTestAssertionPrescription("The message section shall specify all top-level messages defined in the XML Schema that apply to the project implementation and used as a publication message. ");
        return assertion;
    }
}
