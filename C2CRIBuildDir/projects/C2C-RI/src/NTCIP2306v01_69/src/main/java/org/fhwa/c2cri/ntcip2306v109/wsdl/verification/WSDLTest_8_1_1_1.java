...
/**
 * The Class WSDLTest_8_1_1_1.
 *
 * @author TransCore ITS, LLC
 * Last Updated:  1/8/2014
 */
public class WSDLTest_8_1_1_1 implements WSDLTest {
    ...
    /**
     * Instantiates a new wSDL test_8_1_1_1.
     * 
     * Pre-Conditions: N/A
     * Post-Conditions: N/A
     *
     ...
     */
    public WSDLTest_8_1_1_1(RIWSDL wsdlSpec, String wsdlURL) {
    ...
    public TestAssertion perform() {
        ...
        assertion.setTestAssertionID("8.1.1.1");
        try {
            ...
            String xPathStatement = "/wsdl:definitions/wsdl:portType/wsdl:operation[exists(wsdl:input)][not(exists(wsdl:output))]";
            xmlc.toStartDoc();
            ...
            if (xmlc.hasNextSelection()) {
                ...
                assertion.setTestResultDescription("No instances of one-way operations were found in the WSDL file.");
            }
            xmlc.dispose();
        ...
        assertion.setTestAssertionPrescription("The WSDL to describe the simple retrieval of a file shall be described as a one-way operation. ");
        return assertion;
    }
}
