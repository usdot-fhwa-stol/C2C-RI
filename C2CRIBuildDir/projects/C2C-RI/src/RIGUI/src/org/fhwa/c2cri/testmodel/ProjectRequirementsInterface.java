...
/**
 * The Interface ProjectRequirementsInterface represents the headers for the NRTM.
 *
...
public abstract class ProjectRequirementsInterface {
    ...
    public final static String text_Header = "TextData";
    
    /** The Constant type_Header. */
    public final static String type_Header = "ProjectRequirement";
