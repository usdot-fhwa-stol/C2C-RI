...
import org.fhwa.c2cri.testmodel.ProjectRequirements;
...
//        private ProjectRequirements projectRequirements;
    ...
    /**
     * The need related to these requirements.
     */
     ...
     * @param nrtm the nrtm
     */
    public RequirementsTableModel(NRTM nrtm, String relatedNeed) {
        super();
        this.nrtm = nrtm;
        this.relatedNeed = relatedNeed;
        requirementList = nrtm.getNeedRelatedRequirements(relatedNeed);
...
//            System.out.println(" The number of rows was = "+projectRequirements.requirements.size());
 ...
 /* (non-Javadoc)
     ...
     */
    public void setRelatedNeed(String relatedNeed) {
        this.relatedNeed = relatedNeed;
    }
