 ...
 */
package org.fhwa.c2cri.tmddv303d.emulation;
...
public class TMDDv303EntityEmulator
    ...
    public InputStream getDatabaseStream() {
        return this.getClass().getResourceAsStream("/org/fhwa/c2cri/tmddv303d/dbase/TMDDv303SQLLite.db3");
    }

    @Override
    protected String getTMDDEmulatorStandard() {
        return "TMDD v3.03d"; //To change body of generated methods, choose Tools | Templates.
    }
